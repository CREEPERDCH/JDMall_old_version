...
import com.creeperdch.jdmall.adapter.AllOrderAdapter;
...
public class AllOrderFragment extends BaseOrderFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_all_order, container, false);
        initView(view);
        return view;
    }
    ...
    public void onRefresh() {
        mController.sendAsyncMessage(IDiyMessage.ORDER_LIST_ACTION, JDMallApplication.getUserId(), OrderStatus.ALL_ORDER);
    }
}
